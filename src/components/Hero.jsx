    ...
    <div>
        <div className='hidden md:block'>
            <div className='bg-[#ecf1f4] flex items-center justify-between w-full h-auto lg:px-40 md:px-20 sm:px-10 px-4 whitespace-nowrap py-10'>
                <div className='w-[50%] whitespace-nowrap bg-transparent'>
                    ...
                    <div className='bg-white w-[80%] h-14 mt-8 rounded-md px-2 py-[4px] shadow-xl'>
                        <form className='h-full w-full flex gap-x-4'>
                            <input type="text" placeholder="Enter job/program title or keywords" className='focus:outline-none text-sm h-full w-full bg-[#f5f6fa] rounded-md px-4'></input>
                            <button className='h-full bg-[#56bb7c] rounded-md px-4 text-white hover:bg-[#3E9B61] duration-200'><IoSearchSharp /></button>
                        </form>   
                    </div>
                </div>
                ...
                <div className="flex items-end justify-end lg:pr-10 sm:pr-1 pr-0 -mb-16">
                    <img 
                        src={model} 
                        alt="" 
                        className="w-full max-w-[600px] min-w-[400px] h-auto object-contain"
                    />
                </div>
            </div>
        </div>
